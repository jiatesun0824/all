// pages/decoration/cityService/cityService.js
...
Page({
    ...
    onLoad: function(options) {
      ...
      // rzd 埋点 190214 end
      $App.sellingPoint(API, '', this.data.nowPath, this.data.previousPath, '同城服务');
      wx.hideShareMenu();
      this.sellingPoint();
    ...
    getUserLocation(){
      ...
      qqmapsdk = new QQMapWX({
        key: '77JBZ-6RM6P-XD6DO-V5IN3-XIG2V-L4BNE' // 必填
      });
      wx.getLocation({
        type: 'wgs84',
        success: function (res) {
          ...
          qqmapsdk.reverseGeocoder({
            ...
            success: function (addressRes) {
              ...
              API.updateAddress(parms).then(res => {
                console.log(res)
              })
            }
          })
    ...
    toHref: function(e) {
      ...
      switch (index) {
        case 0: $App.sellingPoint(API, 'cityServicedesigner', this.data.nowPath, this.data.previousPath, '同城服务'); break;
        case 1: $App.sellingPoint(API, 'cityServicedesignCompany', this.data.nowPath, this.data.previousPath, '同城服务'); break;
        case 2: $App.sellingPoint(API, 'cityServicedecorationcompany', this.data.nowPath, this.data.previousPath, '同城服务'); break;
        case 3: $App.sellingPoint(API, 'cityServiceForeman', this.data.nowPath, this.data.previousPath, '同城服务'); break;
        case 4: $App.sellingPoint(API, 'cityServiceBuildingmaterialshome', this.data.nowPath, this.data.previousPath, '同城服务'); break;
      }
    },
    toNew(e){
        var sHref = e.currentTarget.dataset.href;
    ...
    toSearch() {
        console.log(this.data.cityCode, this.data.city);
        wx.navigateTo({
    ...
    toCompany(e) {
        let id = e.currentTarget.dataset.id;
      $App.sellingPoint(API, 'cityServicetoCompany', this.data.nowPath, this.data.previousPath, '同城服务');
        wx.navigateTo({
